...
import {
  createOrderSchema,
  createVirtualPlusSubscriptionSchema,
  confirmPaymentSchema,
  updateOrderStatusSchema,
  updateShippingStatusSchema,
  assignRealPlantSchema,
  createPlanSchema,
  updatePlanSchema,
} from "./servicePlan.validator.js";
...
/** GET /api/v1/plans — Danh sách gói dịch vụ public */
...
/** GET /api/v1/plans/my-current — Gói hiện tại của user */
...
/** GET /api/v1/me/entitlements — Quyền tính năng của user */
...
/** POST /api/v1/subscriptions/virtual-plus — Đăng ký Mầm Ảo Plus */
...
/** GET /api/v1/admin/real-plants/available */
...
/** PATCH /api/v1/admin/orders/:id/assign-real-plant */
