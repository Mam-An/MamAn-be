...
import { getOrCreateUserPoints, getAvailablePoints, unlockTrack, getUnlockedTrackIds, } from "./points.service.js";
...
export const unlockTrackHandler = async (req: Request, res: Response) => {
    try {
        ...
        const status = msg.toLowerCase().includes('không tìm thấy') ? 404
